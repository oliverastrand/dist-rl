...
class Learner:
    ...
    def init_neural_net(self, input_values):
        ...
        w_conv2 = weight_variable((self.conv2_size, self.conv2_size, 3, self.conv1_filters,self.conv2_filters), "Weights2")
        b_conv2 = bias_variable([self.conv2_filters],"Bias2")

        w_conv3 = weight_variable((self.conv3_size, self.conv3_size, 3, self.conv2_filters,self.conv3_filters), "Weights3")
